...
import { Button, buttonVariants } from "shadcn-packaged/ui/button";
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        // Increased cell size from 2rem to 2.75rem for less cramped appearance
        // Added more padding (p-4 instead of p-3)
      ...
      classNames={{
        ...
        // Increased weekday text size slightly
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-xs font-medium",
          defaultClassNames.weekday
        ),
        // Added more margin for spacing between header and days
...
function CalendarDayButton({ className, day, modifiers, ...props }: any) {
  ...
  return (
    <Button
      ...
      className={cn(
        // Improved day button styles with better sizing
        "data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground",
        "data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground",
        "data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground",
        "data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground",
        "group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50",
        "flex aspect-square h-auto w-full min-w-[--cell-size] flex-col gap-1 font-medium leading-none text-sm",
